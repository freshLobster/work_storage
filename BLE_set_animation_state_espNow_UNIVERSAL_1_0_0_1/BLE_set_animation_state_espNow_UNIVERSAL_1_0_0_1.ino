...
#define SERVICE_UUID "12345678-1234-1234-1234-1234567890AB"  // Replace with unique 128-bit UUID
#define CHARACTERISTIC_UUID "87654321-4321-4321-4321-BA0987654321"  // Replace with unique 128-bit UUID
...
class CharacteristicCallBack : public BLECharacteristicCallbacks {
  void onWrite(BLECharacteristic *pChar) override {
    ...
    String pChar_value_string = pChar->getValue();
